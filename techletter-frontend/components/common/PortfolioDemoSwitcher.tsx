...
export default function PortfolioDemoSwitcher() {
  ...
  return (
    <>
      <div className="fixed right-3 top-4 z-[10000] flex items-center gap-2 sm:right-4">
        {activeRole && (
      ...
      {notice && (
        <div className="fixed bottom-24 left-1/2 z-[10002] w-[min(92vw,440px)] -translate-x-1/2 rounded-xl bg-gray-950 px-4 py-3 text-sm text-white shadow-2xl">
          {notice}
        </div>
      )}
