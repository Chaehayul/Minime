...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-200 bg-white shadow-[0_-1px_0_rgba(0,0,0,0.03)] dark:border-[#2e2e2e] dark:bg-[#0b0b0b] dark:shadow-none">
